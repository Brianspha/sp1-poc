...
export interface SwapAdapter {
    ...
    approve(wallet: `0x${string}`, spender: `0x${string}`, token: TokenInfo, amount: bigint): Promise<SwapExecution>;
    swap(wallet: `0x${string}`, request: QuoteRequest): Promise<SwapExecution>;
}
export type SwapStatus = "connecting" | "idle" | "quoting" | "approval-required" | "approving" | "switching-chain" | "ready" | "swapping" | "success" | "error";
