...
export function formatSignedUnits(value, decimals, precision = 4) {
    if (value === 0n) {
        return "0";
    }
...
export function formatAttestationLabel(attestationCount) {
